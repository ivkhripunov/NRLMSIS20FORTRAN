...
program msistest
  ...
  !Initialize model
  call msisinit(parmpath='/home/ivankhripunov/CLionProjects/NRLMSIS2.0/',parmfile='msis20.parm')

  !Open input and output files, loop through records, and call model
  open(77,file='/home/ivankhripunov/CLionProjects/NRLMSIS2.0/msis2.0_test_in.txt',status='old')
  open(78,file='/home/ivankhripunov/CLionProjects/NRLMSIS2.0/msis2.0_test_out.txt',status='replace')
  read(77,*) dummy
